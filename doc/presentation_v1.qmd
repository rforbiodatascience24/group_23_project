...
<img src="../results/02_boxplot_1.png" style="width: 49%; height: auto;"/> <img src="../results/02_boxplot_2.png" style="width: 49%; height: auto;"/>
:::
...
![](../results/03_Heatmap_pvsp_genotype.png){fig-align="center"}
...
::: {style="display: flex; justify-content: space-between; align-items: center;"}
<img src="../results/04_densitogram_1.png" style="width: 49%; height: auto;"/> <img src="../results/04_densitogram_2.png" style="width: 49%; height: auto;"/>
:::
...
::: {style="display: flex; justify-content: space-between; align-items: center;"}
<img src="../results/05_MAPK.png" style="width: 48%; height: auto;"/> <img src="../results/05_CAI.png" style="width: 48%; height: auto;"/>
:::
...
![](../results/06_PCA.png){fig-align="center"}
