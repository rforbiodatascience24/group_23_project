...
#p1 <- densitogram(trisomic, "BRAF_N")
#p1
```
...
In general, trisomic classes appear to have more diverse distributions than controls, which was also noticed in the first analysis and for BRAF_N as well.
