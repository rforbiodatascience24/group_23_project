...
We chose the threshold of 0.01 because it was the highest (reasonable) value that created a distinction between significant and non-significant values. With a higher threshold (e.g., 5%), there were no differences between significant and non-significant values, as all values were classified as significant.
