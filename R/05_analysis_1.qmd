...
Going into details, we pick the two proteins that we used to create the model in 04_describe (BRAF and pERK), and we analize their expression levels based on the class.
...
The expression levels of BRAF appear to be more stable and less variable, especially in the control group. Instead, pERK shows greater variability across classes, particularly in the trisomy group: this is represented by larger boxes, longer whiskers and a higher number of outliers. However, they both present most of the outliers in c-CS-s and a very small variance in c-SC-m and c-SC-s.
